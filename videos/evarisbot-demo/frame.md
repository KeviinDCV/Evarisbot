...
colors:
  ...
  text-muted: "#5c6485"
  text-light: "#767b90"
  accent-light: "rgba(46, 63, 132, 0.08)"
  accent-medium: "rgba(46, 63, 132, 0.15)"
  border: "rgba(46, 63, 132, 0.2)"
  card-bg: "rgba(46, 63, 132, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
- **Fonts** — already set to **Instrument Sans** (display) / **ui-sans-serif** (body); ignore any preset font name lingering in prose.
