...
<head>
    ...
    <title>Acceso denegado - Evarisbot HUV</title>
    <style>
...
<body>
    <div class="container">
        ...
        <p>No tienes permisos para acceder a esta página. Si crees que es un error, contacta al administrador del sistema.</p>
