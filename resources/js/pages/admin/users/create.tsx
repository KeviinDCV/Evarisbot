            ...
            <div className="min-h-screen bg-background p-4 md:p-6 lg:p-8">
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="mb-6 md:mb-8">
                        ...
                        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold settings-title">{t('users.createTitle')}</h1>
                        <p className="text-sm md:text-base mt-1 settings-subtitle">{t('users.createSubtitle')}</p>
                    </div>
