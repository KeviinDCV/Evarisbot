            ...
            <div className="min-h-screen bg-background p-4 md:p-6 lg:p-8">
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="mb-6 md:mb-8">
                        ...
                        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold dark:text-[hsl(231,15%,92%)]" style={{ color: '#2e3f84' }}>{t('users.createTitle')}</h1>
                        <p className="text-sm md:text-base mt-1 dark:text-[hsl(231,15%,60%)]" style={{ color: '#6b7494' }}>{t('users.createSubtitle')}</p>
                    </div>
